...
= 0.5.17 =
* Fixed deprecation notice about fetching multiple feeds with single SimplePie instance (in theme news)
* Fixed missing plugin name in readme.txt header
* Bumped supported WordPress version to 6.9
